...
//  private String from;
    ...
    /**
     * Estableceel el conjunto de caracteres a utilizar para el texto del título
     * y del cuerpo del mensaje
     */
...
//  }
    ...
    /**
     * Devuelve un array de objetos InternetAddress, cada uno de los cuales es
     * la dirección de un destinatario del mensaje
     *
    ...
    /**
     * Devuelve un array de objetos InternetAddress, cada uno de los cuales es
     * la dirección de un destinatario oculto (BCC) del mensaje
     *
     * @throws AddressException
     */
    ...
    /**
     * Añade un destinatatio oculto a los destinatarios ocultos (BCC) del
     * mensaje
     *
    ...
    /**
     * Devuelve un array de objetos InternetAddress, cada uno de los cuales es
     * la dirección de un destinatario al que se envía una copia (CC) del
     * mensaje
     *
     * @throws AddressException
     */
    ...
    /**
     * Añade un destinatatio a la lista destinatarios a los que se envía una
     * copia (CC) del mensaje
     *
     ...
     *
     * @param nombre Nombre del adjunto (nombre del fichero con el que se
     * enviará el adjunto). Si el mensaje ya incluye un adjunto con ese nombre,
     * el fichero existente será sustituido por el nuevo.
    ...
    /**
     * Devuelve la ruta de fichero asociada a un determinado nombre de fichero
