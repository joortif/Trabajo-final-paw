...
<%-- 
    Document   : index
    Created on : 06-feb-2012, 12:35:24
    Author     : fgarcia
--%>
              ...
              <ul>  
                <li class="celda">
                  ...
                  <div class="parteCelda2">
                    ...
                    <div style="float:right; padding:10px 5px">
                      <a style="padding:5px 8px 5px 10px;background:#5C7E6D;color:#FFF" href="../generica.html" ><span>Sepa por qu&eacute; ...</span> </a>
                    </div>
                  </div>
                  <div class="clear"></div>
                </li> 
                <li class="celda">
                  ...
                  <div class="parteCelda2">
                    ...
                    <div style="float:right; padding:10px 5px">
                      <a style="padding:5px 8px 5px 10px;background:#5C7E6D;color:#FFF" href="../generica.html" ><span>Comenzar ...</span> </a>
                    </div>
                  </div>
                  <div class="clear"></div>
                </li> 
              ...
              <ul>  
                <li class="celda">
                  ...
                  <div class="parteCelda2">
                    ...
                    <div style="float:right; padding:10px 5px">
                      <a style="padding:5px 8px 5px 10px;background:#5C7E6D;color:#FFF" href="../generica.html" ><span>Registrar ...</span> </a>
                    </div>
                  </div>
                  <div class="clear"></div>
                </li> 
                <li class="celda">
                  ...
                  <div class="parteCelda2">
                    ...
                    <div style="float:right; padding:10px 5px">
                      <a style="padding:5px 8px 5px 10px;background:#5C7E6D;color:#FFF" href="../generica.html" ><span>M&aacute;s ...</span> </a>
                    </div>
                  </div>
                  <div class="clear"></div>
                </li> 			
